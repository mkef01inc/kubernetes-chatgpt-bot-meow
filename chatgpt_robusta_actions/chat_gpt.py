    ...
    try:
        if params.search_term in lru_cache:
            ...
            input = [
                ...
                {"role": "user", "content": f"And finish with the ascii art of a cat"},
            ]
